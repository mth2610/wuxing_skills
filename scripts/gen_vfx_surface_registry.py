...
def main():
    ...
    for profile in profiles:
        ...
        f"        .blend = {BLENDS[profile['blend']]},",
            ...
            f"        .lightMapBPath = {c_string(asset(profile, 'lightmap_b', 'path'))},",
            f"        .normalPath = {c_string(asset(profile, 'normal', 'path'))},",
        ...
        f"        .gradientPath = {c_string(asset(profile, 'gradient', 'path'))},",
            ...
            f"        .lightMapBChannels = {c_string(asset(profile, 'lightmap_b', 'channels'))},",
            f"        .normalChannels = {c_string(asset(profile, 'normal', 'channels'))},",
