...
void main()
{
    ...
    if (u_useTexture != 0 && fragTexCoord.x >= 0.0) {
        ...
        // The atlas is neutral grayscale albedo with realistic veins, relief, and transparency.
        // Modulate texel with the vertex color (flower petalColor, centerColor, or reed plumeColor).
        albedo *= texel.rgb;
    } else {
