...
typedef enum {
    ...
    VFX_SURFACE_FIRE_TONGUE_01,
    VFX_SURFACE_SMOKE_PUFF_DENSE,
    VFX_SURFACE_PLASMA_WISPS_VORTEX,
    VFX_SURFACE_EXPLOSION_CORE_NIAGARA,
    VFX_SURFACE_EXPLOSION_ROIL_NIAGARA,
    VFX_SURFACE_EXPLOSION_BURST_NIAGARA,
    VFX_SURFACE_EXPLOSION_WIDE_NIAGARA,
