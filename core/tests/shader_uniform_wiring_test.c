...
int main(void)
{
    ...
    // scene_targets.c is in the list because the soft-particle uniforms
    // (u_cameraDepthTex/Near/Far, u_resolution) are uploaded by
    // SceneTargets_BindDepthForSoftParticles, not by the particle system
