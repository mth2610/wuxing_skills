# core/docs/EXTERNAL_API.md — Wuxing Skills: Standalone Skill Creation Reference
...
```
Project:  Wuxing Skills (C / Raylib 6.0; Vulkan 1.1 via rlvk priority, GL 3.3 / GLES fallback; isometric night arena)
