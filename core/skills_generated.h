...
#include "skills/fire/magma_fissure_skill/magma_fissure_skill.h"
...
static inline void RegisterGeneratedSkills(void) {
    ...
    RegisterSkill("MAGMA_FISSURE", ELEMENT_COLOR_FIRE, InitMagmaFissureSkill, CastMagmaFissureSkill, UpdateMagmaFissureSkill, DrawMagmaFissureSkill, UnloadMagmaFissureSkill);
