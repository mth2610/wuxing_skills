...
void GpuParticleSystem_Spawn(GpuParticleConfig cfg)
{
    ...
    d.vz = cfg.velocity.z;
    d.drag = cfg.drag;
    d.csr = cfg.colorStart.r / 255.0f;
    d.csg = cfg.colorStart.g / 255.0f;
    d.csb = cfg.colorStart.b / 255.0f;
    d.csa = cfg.colorStart.a / 255.0f;
    d.cer = cfg.colorEnd.r / 255.0f;
    d.ceg = cfg.colorEnd.g / 255.0f;
    d.ceb = cfg.colorEnd.b / 255.0f;
