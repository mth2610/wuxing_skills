...
static void VFXTest_StopFixtures(void)
{
    ...
    if (s_vfxFixtureHandle[27] >= 0)
        VFX_KillTrail(s_vfxFixtureHandle[27]);
    ...
    if (s_vfxFixtureHandle[33] >= 0)
        VFX_KillVolumeTrail(s_vfxFixtureHandle[33]);
...
static bool VFXTest_FireNewFx(int newfxIndex, Vector3 pos)
{
    ...
    case 38: VFX_ComposeFluidImpact(pos); return true;
    case 39: VFX_ComposeIceCrystal(pos, posSeed); return true;
    case 41: VFX_ComposeWaterOrb(Vector3Add(pos, (Vector3){-2.0f, 1.2f, 0.0f}), Vector3Add(pos, (Vector3){2.5f, 1.8f, 0.8f})); return true;
...
// 44 entries — auto-managed by sync_vfx_test.py
        ...
        else if (s_testCategory == TEST_CAT_NEWFX)
        {
          ...
          switch (s_testIndex) {
              ...
              case 27:
              {
                  ...
                  if (s_vfxFixtureHandle[27] < 0)
                      s_vfxFixtureHandle[27] = VFX_ComposeTrail(&s_vfxFixtureXf[27], VC_MAT_FIRE, 0.1f, 2.0f, TRAIL_PRESET_MAIN);
                  break;
              }
              case 28:
              {
                  ...
                  if (s_vfxFixtureHandle[28] < 0)
                      s_vfxFixtureHandle[28] = VFX_ComposeTrail(&s_vfxFixtureXf[28], VC_MAT_FIRE, 0.0f, 2.0f, TRAIL_PRESET_ENERGY);
                  break;
              }
              case 29:
              {
                  ...
                  if (s_vfxFixtureHandle[29] < 0)
                      s_vfxFixtureHandle[29] = VFX_ComposeTrail(&s_vfxFixtureXf[29], VC_MAT_FIRE, 0.1f, 2.0f, TRAIL_PRESET_BLADE);
                  break;
              }
              case 30:
              {
                  ...
                  if (s_vfxFixtureHandle[30] < 0)
                      s_vfxFixtureHandle[30] = VFX_ComposeTrail(&s_vfxFixtureXf[30], VC_MAT_FIRE, 0.1f, 2.0f, TRAIL_PRESET_WISP);
                  break;
              }
              case 31:
              {
                  ...
                  if (s_vfxFixtureHandle[31] < 0)
                      s_vfxFixtureHandle[31] = VFX_ComposeTrail(&s_vfxFixtureXf[31], VC_MAT_FIRE, 0.15f, 2.0f, TRAIL_PRESET_BACKDROP);
                  break;
              }
              case 32:
              {
                  ...
                  if (s_vfxFixtureHandle[32] < 0)
                      s_vfxFixtureHandle[32] = VFX_ComposeTrail(&s_vfxFixtureXf[32], VC_MAT_FIRE, 0.0f, 2.0f, TRAIL_PRESET_SMOKE);
                  break;
              }
              case 33:
              {
                  ...
                  if (s_vfxFixtureHandle[33] < 0)
                      s_vfxFixtureHandle[33] = VFX_ComposeVolumeTrail(&s_vfxFixtureXf[33], VC_MAT_FIRE, 1.5f, 2.0f, VOL_ENERGY);
                  break;
              }
              case 34: VFX_ComposeFissureStreak(Vector3Add(s_prefabStartPos, (Vector3){-2.0f, 1.2f, 0.0f}), Vector3Add(s_prefabStartPos, (Vector3){2.5f, 1.8f, 0.8f}), 0.1f, progress, s_meshTime); break;
