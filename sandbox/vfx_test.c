...
static void VFXTest_StopFixtures(void)
{
    ...
    if (s_vfxFixtureHandle[20] >= 0)
        VFX_KillRibbonTrail(s_vfxFixtureHandle[20]);
...
static bool VFXTest_FireNewFx(int newfxIndex, Vector3 pos)
{
    ...
    case 7:
        ...
        return true;
    case 8:
        VFX_ComposeDecal(pos, VC_MAT_ICE, 1.5f, 0.0f, 1.5f);
        return true;
    case 10:
        if (s_vfxFixtureHandle[10] >= 0)
            VFX_KillEmberTrail(s_vfxFixtureHandle[10]);
...
void VFXTest_Draw3D(void)
{
    ...
    if (s_isPlayingMesh)
    {
        ...
        else if (s_testCategory == TEST_CAT_NEWFX)
        {
            ...
            {
            case 0:
                VFX_ComposeBeam(Vector3Add(s_prefabStartPos, (Vector3){-2.0f, 1.2f, 0.0f}), Vector3Add(s_prefabStartPos, (Vector3){2.5f, 1.8f, 0.8f}), VC_MAT_FIRE, 0.1f, progress);
                break;
            case 2:
            ...
            case 6:
            {
                ...
                if (s_meshTime < s_vfxFixtureLastTime[6] && s_vfxFixtureHandle[6] >= 0)
                    KillTrail(s_vfxFixtureHandle[6]);
                if (s_meshTime < s_vfxFixtureLastTime[6])
                    s_vfxFixtureHandle[6] = -1;
            ...
            case 19:
            {
                ...
                if (s_meshTime < s_vfxFixtureLastTime[19] && s_vfxFixtureHandle[19] >= 0)
                    VFX_KillProjectile(s_vfxFixtureHandle[19]);
                if (s_meshTime < s_vfxFixtureLastTime[19])
                    s_vfxFixtureHandle[19] = -1;
            ...
            case 20:
            {
                ...
                if (s_meshTime < s_vfxFixtureLastTime[20] && s_vfxFixtureHandle[20] >= 0)
                    VFX_KillRibbonTrail(s_vfxFixtureHandle[20]);
                if (s_meshTime < s_vfxFixtureLastTime[20])
                    s_vfxFixtureHandle[20] = -1;
                s_vfxFixtureLastTime[20] = s_meshTime;
                s_vfxFixtureXf[20] = MatrixTranslate(fixturePos.x, fixturePos.y, fixturePos.z);
                if (s_vfxFixtureHandle[20] < 0)
                    s_vfxFixtureHandle[20] = VFX_ComposeRibbonTrail(&s_vfxFixtureXf[20], VC_MAT_FIRE, 0.1f, 2.0f, VFX_RIBBON_MAIN);
                break;
            }
            case 21:
            ...
            case 27:
            {
                ...
                if (s_meshTime < s_vfxFixtureLastTime[27] && s_vfxFixtureHandle[27] >= 0)
                    VFX_KillVolumeTrail(s_vfxFixtureHandle[27]);
                if (s_meshTime < s_vfxFixtureLastTime[27])
                    s_vfxFixtureHandle[27] = -1;
