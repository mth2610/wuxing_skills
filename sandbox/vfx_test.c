...
static const char* s_newFxNames[] = {
    ...
    "GLINT SPARKLE", "RUNE CIRCLE", "CHARGE CONVERGE",
};
// @gen:newfx_names end
    ...
    if (s_isPlayingMesh)
    {
        ...
        else if (s_testCategory == TEST_CAT_NEWFX)
        {
          ...
          switch (s_testIndex) {
              ...
              case 68: VFX_ComposeChargeConverge(Vector3Add(s_prefabStartPos, (Vector3){0.0f, 0.9f, 0.0f}), VC_MAT_LIGHTNING, 1.3f, fmodf(s_meshTime, 2.2f) / 2.2f, 45); break;
          }
// @gen:newfx_draw end
        }
    }
