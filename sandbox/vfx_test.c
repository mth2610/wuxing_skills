...
static const char* s_newFxNames[] = {
    ...
    "ENERGY TRAIL", "DEBRIS SHARDS", "DECAL", "DISSOLVE EXIT", "EMBER TRAIL", "ENERGY BURST",
    "ENERGY ORB", "GLINT SPARKLE", "GROUND WAVE", "IMPACT DUST", "IMPACT PACKAGE", "LIGHT SHAFT",
    "PORTAL DISC", "PROJECTILE", "RIBBON TRAIL", "RUNE CIRCLE", "SHIELD SHELL", "SHOCK RING",
        ...
        else if (s_testCategory == TEST_CAT_NEWFX)
        {
          ...
          switch (s_testIndex) {
              ...
              case 6:
              {
                  ...
                  if (s_vfxFixtureHandle[6] < 0)
                      s_vfxFixtureHandle[6] = VFX_ComposeEnergyTrail(&s_vfxFixtureXf[6], VC_MAT_FIRE, 1.5f, 2.0f);
                  break;
              }
              case 9: VFX_ComposeDissolveExit(s_prefabStartPos, VC_MAT_FIRE, 1.5f, progress); break;
              case 12: VFX_ComposeEnergyOrb(s_prefabStartPos, VC_MAT_FIRE, 1.5f, progress); break;
