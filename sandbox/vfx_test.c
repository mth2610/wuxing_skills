...
static bool VFXTest_FireNewFx(int newfxIndex, Vector3 pos)
{
    ...
    case 30:
        if (s_vfxFixtureHandle[30] >= 0) VFX_KillShieldShell(s_vfxFixtureHandle[30]);
        s_vfxFixtureHandle[30] = VFX_ShieldShell_Spawn(pos, VC_MAT_WATER, 1.5f, 1.0f);
        return true;
    case 33: VFX_ComposeSmokePuff(pos, VC_MAT_FIRE, 1.5f, 1.0f); return true;
    case 48: VFX_ComposeFluidImpact(pos); return true;
    case 49: VFX_ComposeIceCrystal(pos, posSeed); return true;
    case 51: VFX_ComposeWaterOrb(Vector3Add(pos, (Vector3){-2.0f, 1.2f, 0.0f}), Vector3Add(pos, (Vector3){2.5f, 1.8f, 0.8f})); return true;
...
static const char* s_newFxNames[] = {
    ...
    "LIGHTNING IMPACT", "PORTAL DISC", "REF BANDS", "REF PARTICLES", "RIFT BOLT", "RUNE CIRCLE",
    "SHIELD SHELL", "SHOCK RING", "SMOKE COLUMN", "SMOKE PUFF", "SMOKE TRAIL", "SWEEP SLASH",
    "TRAIL MAIN", "TRAIL ENERGY", "TRAIL BLADE", "TRAIL WISP", "TRAIL BACKDROP", "TRAIL SMOKE",
    "TRAIL MAGIC", "VOLUME TRAIL", "FISSURE STREAK", "STONE PILLAR", "FLAME VOLUME", "BLACK HOLE",
    ...
    if (s_isPlayingMesh)
    {
        ...
        else if (s_testCategory == TEST_CAT_NEWFX)
        {
          ...
          switch (s_testIndex) {
              ...
              case 25: VFX_ComposePortalDisc(s_prefabStartPos, (Vector3){0.0f, 1.0f, 0.0f}, VC_MAT_FIRE, 1.5f, progress); break;
              case 26:
              {
                  ...
                  if (s_vfxFixtureHandle[26] < 0)
                      s_vfxFixtureHandle[26] = VFX_ComposeRefBands(s_prefabStartPos, 1.5f);
                  break;
              }
              case 27:
              {
                  ...
                  if (s_vfxFixtureHandle[27] < 0)
                      s_vfxFixtureHandle[27] = VFX_ComposeRefParticles(s_prefabStartPos, 1.5f);
                  break;
              }
              case 28:
              {
                  ...
                  s_vfxFixtureXf[28] = MatrixTranslate(fixturePos.x, fixturePos.y, fixturePos.z);
                  if (s_vfxFixtureHandle[28] < 0)
                      s_vfxFixtureHandle[28] = VFX_ComposeRiftBolt(&s_vfxFixtureXf[28], VC_MAT_FIRE, 0.08f);
                  break;
              }
              case 29: VFX_ComposeRuneCircle(s_prefabStartPos, (Vector3){0.0f, 1.0f, 0.0f}, VC_MAT_FIRE, 1.5f, progress, 5); break;
              case 31: VFX_ComposeShockRing(s_prefabStartPos, (Vector3){0.0f, 1.0f, 0.0f}, VC_MAT_FIRE, 1.5f, progress); break;
              case 32:
              {
                  ...
                  if (s_vfxFixtureHandle[32] < 0)
                      s_vfxFixtureHandle[32] = VFX_ComposeSmokeColumn(s_prefabStartPos, VC_MAT_METAL, 0.55f, 5.0f, VFX_COLUMN_SMOKE, true);
                  break;
              }
              case 34:
              {
                  ...
                  if (s_vfxFixtureHandle[34] < 0)
                      s_vfxFixtureHandle[34] = VFX_ComposeSmokeTrail(&s_vfxFixtureXf[34], VC_MAT_METAL, 0.18f, 1.0f, VFX_COLUMN_SMOKE, true);
                  break;
              }
              ...
              case 36:
              {
                  ...
                  if (s_vfxFixtureHandle[36] < 0)
                      s_vfxFixtureHandle[36] = VFX_ComposeTrail(&s_vfxFixtureXf[36], VC_MAT_FIRE, 0.1f, 2.0f, TRAIL_PRESET_MAIN);
                  break;
              }
              case 37:
              {
                  ...
                  if (s_vfxFixtureHandle[37] < 0)
                      s_vfxFixtureHandle[37] = VFX_ComposeTrail(&s_vfxFixtureXf[37], VC_MAT_FIRE, 0.0f, 2.0f, TRAIL_PRESET_ENERGY);
                  break;
              }
              case 38:
              {
                  ...
                  if (s_vfxFixtureHandle[38] < 0)
                      s_vfxFixtureHandle[38] = VFX_ComposeTrail(&s_vfxFixtureXf[38], VC_MAT_FIRE, 0.1f, 2.0f, TRAIL_PRESET_BLADE);
                  break;
              }
              case 39:
              {
                  ...
                  if (s_vfxFixtureHandle[39] < 0)
                      s_vfxFixtureHandle[39] = VFX_ComposeTrail(&s_vfxFixtureXf[39], VC_MAT_FIRE, 0.1f, 2.0f, TRAIL_PRESET_WISP);
                  break;
              }
              case 40:
              {
                  ...
                  if (s_vfxFixtureHandle[40] < 0)
                      s_vfxFixtureHandle[40] = VFX_ComposeTrail(&s_vfxFixtureXf[40], VC_MAT_FIRE, 0.15f, 2.0f, TRAIL_PRESET_BACKDROP);
                  break;
              }
              case 41:
              {
                  ...
                  if (s_vfxFixtureHandle[41] < 0)
                      s_vfxFixtureHandle[41] = VFX_ComposeTrail(&s_vfxFixtureXf[41], VC_MAT_FIRE, 0.0f, 2.0f, TRAIL_PRESET_SMOKE);
                  break;
              }
              case 42:
              {
                  ...
                  if (s_vfxFixtureHandle[42] < 0)
                      s_vfxFixtureHandle[42] = VFX_ComposeTrail(&s_vfxFixtureXf[42], VC_MAT_FIRE, 0.0f, 2.0f, TRAIL_PRESET_MAGIC);
                  break;
              }
              case 43:
              {
                  ...
                  if (s_vfxFixtureHandle[43] < 0)
                      s_vfxFixtureHandle[43] = VFX_ComposeVolumeTrail(&s_vfxFixtureXf[43], VC_MAT_FIRE, 1.5f, 2.0f, VOL_ENERGY);
                  break;
              }
              ...
              case 46: VFX_ComposeFlameVolume(s_prefabStartPos, VC_MAT_FIRE, 1.5f, 1.0f); break;
              case 47: VFX_ComposeBlackHole(VC_MAT_FIRE, s_prefabStartPos, 1.5f, s_meshTime); break;
              case 50: VFX_ComposeLiquidBench(s_prefabStartPos, 1.1f, 1.0f); break;
              case 52: VFX_ComposeWaterRing(s_prefabStartPos, 0.9f, 1.0f); break;
              case 53: VFX_ComposeWaterStream(Vector3Add(s_prefabStartPos, (Vector3){-2.0f, 1.2f, 0.0f}), Vector3Add(Vector3Lerp(Vector3Add(s_prefabStartPos, (Vector3){-2.0f, 1.2f, 0.0f}), Vector3Add(s_prefabStartPos, (Vector3){2.5f, 1.8f, 0.8f}), 0.33f), (Vector3){0.0f, 0.9f, 0.7f}), Vector3Add(Vector3Lerp(Vector3Add(s_prefabStartPos, (Vector3){-2.0f, 1.2f, 0.0f}), Vector3Add(s_prefabStartPos, (Vector3){2.5f, 1.8f, 0.8f}), 0.66f), (Vector3){0.0f, 0.5f, -0.7f}), Vector3Add(s_prefabStartPos, (Vector3){2.5f, 1.8f, 0.8f}), 1.5f, progress, s_meshTime); break;
          }
// @gen:newfx_draw end
        }
    }
