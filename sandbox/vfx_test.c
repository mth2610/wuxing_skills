...
// @gen:newfx_fire begin
    ...
    case 32: VFX_ComposeIceCrystal(pos, posSeed); return true;
...
// 34 entries — auto-managed by sync_vfx_test.py
static const char* s_newFxNames[] = {
    ...
    "FLAME VOLUME", "BLACK HOLE", "ICE CRYSTAL", "WATER STREAM",
};
// @gen:newfx_names end
