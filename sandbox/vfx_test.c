...
static const char* s_newFxNames[] = {
    ...
    "PROJECTILE", "RIBBON TRAIL", "RUNE CIRCLE", "SHIELD SHELL", "SHOCK RING", "SMOKE COLUMN",
    "SMOKE PUFF", "SPARK TRAIL", "STRAND TRAIL", "SWEEP SLASH", "VOLUME TRAIL", "FISSURE STREAK",
        ...
        else if (s_testCategory == TEST_CAT_NEWFX)
        {
          ...
          switch (s_testIndex) {
              ...
              case 23:
              {
                  ...
                  if (s_vfxFixtureHandle[23] < 0)
                      s_vfxFixtureHandle[23] = VFX_ComposeSmokeColumn(s_prefabStartPos, VC_MAT_METAL, 0.55f, 3.0f, VFX_COLUMN_SMOKE, false);
                  break;
              }
              case 26:
              {
