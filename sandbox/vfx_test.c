...
static bool VFXTest_FireNewFx(int newfxIndex, Vector3 pos)
{
    ...
    case 26:
        if (s_vfxFixtureHandle[26] >= 0) VFX_KillShieldShell(s_vfxFixtureHandle[26]);
        s_vfxFixtureHandle[26] = VFX_ShieldShell_Spawn(pos, VC_MAT_WATER, 1.5f, 1.0f);
        return true;
    case 29: VFX_ComposeSmokePuff(pos, VC_MAT_FIRE, 1.5f, 1.0f); return true;
...
static const char* s_newFxNames[] = {
    ...
    "FLOW SHIELD", "GAS PLUME", "GLINT SPARKLE", "GROUND WAVE", "IMPACT DUST", "IMPACT PACKAGE",
    "LIGHT SHAFT", "LIGHTNING ARC", "LIGHTNING IMPACT", "PORTAL DISC", "REF BANDS", "REF PARTICLES",
    "RIFT BOLT", "RUNE CIRCLE", "SHIELD SHELL", "SHOCK RING", "SMOKE COLUMN", "SMOKE PUFF",
    "SMOKE TRAIL", "SWEEP SLASH", "TRAIL MAIN", "TRAIL ENERGY", "TRAIL BLADE", "TRAIL WISP",
    "TRAIL BACKDROP", "TRAIL SMOKE", "TRAIL MAGIC", "VOLUME TRAIL", "FISSURE STREAK", "STONE PILLAR",
        ...
        else if (s_testCategory == TEST_CAT_NEWFX)
        {
          ...
          switch (s_testIndex) {
              ...
              case 24:
              {
                  ...
                  if (s_vfxFixtureHandle[24] < 0)
                      s_vfxFixtureHandle[24] = VFX_ComposeRiftBolt(&s_vfxFixtureXf[24], VC_MAT_FIRE, 0.08f);
                  break;
              }
              case 25: VFX_ComposeRuneCircle(s_prefabStartPos, (Vector3){0.0f, 1.0f, 0.0f}, VC_MAT_FIRE, 1.5f, progress, 5); break;
              case 27: VFX_ComposeShockRing(s_prefabStartPos, (Vector3){0.0f, 1.0f, 0.0f}, VC_MAT_FIRE, 1.5f, progress); break;
              case 28:
              {
                  ...
                  if (s_vfxFixtureHandle[28] < 0)
                      s_vfxFixtureHandle[28] = VFX_ComposeSmokeColumn(s_prefabStartPos, VC_MAT_METAL, 0.55f, 5.0f, VFX_COLUMN_SMOKE, true);
                  break;
              }
              case 30:
              {
                  ...
                  if (s_vfxFixtureHandle[30] < 0)
                      s_vfxFixtureHandle[30] = VFX_ComposeSmokeTrail(&s_vfxFixtureXf[30], VC_MAT_METAL, 0.18f, 1.0f, VFX_COLUMN_SMOKE, true);
                  break;
              }
              ...
              case 38:
              {
                  ...
                  if (s_vfxFixtureHandle[38] < 0)
                      s_vfxFixtureHandle[38] = VFX_ComposeTrail(&s_vfxFixtureXf[38], VC_MAT_FIRE, 0.0f, 2.0f, TRAIL_PRESET_MAGIC);
                  break;
              }
              case 39:
              {
                  ...
                  if (s_vfxFixtureHandle[39] < 0)
                      s_vfxFixtureHandle[39] = VFX_ComposeVolumeTrail(&s_vfxFixtureXf[39], VC_MAT_FIRE, 1.5f, 2.0f, VOL_ENERGY);
                  break;
              }
              ...
              case 42: VFX_ComposeFlameVolume(s_prefabStartPos, VC_MAT_FIRE, 1.5f, 1.0f); break;
